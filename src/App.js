...
const newsItems = [
  {
    date: "Jan. 2026",
    text: "Paper [C.4] accepted at WWW 2026.",
  ...
  {
    date: "2025",
    text: "Paper [C.2] accepted at ACM SenSys 2025.",
    link: "https://arxiv.org/abs/2404.15305",
    linkLabel: "Paper",
  },
  {
    date: "2024",
    text: "Paper [C.1] accepted at EMNLP 2024.",
    link: "https://arxiv.org/abs/2407.10385",
    linkLabel: "Paper",
  },
  {
    date: "2024",
    text: "Paper [C.3] presented at Korean Software Conference (KSC 2024).",
...
function App() {
  return (
    <main>
      ...
      <h1 className="name">Biniyam Aschalew Tolera</h1>

      <div id="intro">
        <p>
          I am a current M.S. student in Electrical Engineering at{" "}
          <a href="https://www.kaist.ac.kr/en/" target="_blank" rel="noreferrer">
            KAIST
          </a>
          , and I am a researcher in{" "}
          <a href="https://dai.kaist.ac.kr/" target="_blank" rel="noreferrer">
            Data AI Lab
          </a>{" "}
          advised by{" "}
          <a href="https://jaeminyoo.github.io/" target="_blank" rel="noreferrer">
            Prof. Jaemin Yoo
          </a>
          .
        </p>
        ...
        <p>
          My work focuses on transfer learning and robust representation learning
          for graph and sensor-based machine learning systems. I am also
          interested in multimodal large language models and adaptation methods
          for real-world environments.
        </p>

        <p>
          Previously, I received my B.S. degree in Computer Science from KAIST
          (Magna Cum Laude), and I worked with both Data AI Lab and Networking
          and Mobile Systems Lab on research that led to publications at EMNLP,
          SenSys, KSC, and WWW.
        </p>
      </div>
      ...
      <section id="publications">
        <h2 className="section">Publications</h2>
        <hr className="divider" />

        {publications.map((paper) => (
          <p className="pub-entry" key={`${paper.id}-${paper.title}`}>
            <span className="paper">
              {paper.id} {paper.title}
            </span>
            <br />
            <span className="authors">{renderAuthors(paper.authors)}</span>
            <br />
